          ...
          <div class="row d-flex align-items-center flex-wrap">
            ...
            <div class="col-md-5">
              <ul class="breadcrumb d-flex justify-content-end">
                ...
                <li class="breadcrumb-item active">Membership Withdrawal</li>
              </ul>
            </div>
          </div>
        </div>
        ...
        <div class="container">
          <div class="row bar mb-0">
            <div id="customer-orders" class="col-md-9">
              <p class="text-muted lead">You can Membership Withdrawal</p>
                ...
                <form>
                  <div class="row">
                    ...
                    <div class="col-md-12 text-center">
                      <button type="submit" class="btn btn-template-outlined"><i class="fa fa-envelope-o"></i>탈퇴</button>
                      <button type="submit" class="btn btn-template-outlined"><i class="fa fa-envelope-o"></i>취소</button>
                    </div>
                  </div>
                </form>
              </div>
    ...
    <!------------  <li class="nav-item"><a href="index.html" class="nav-link"><i class="fa fa-sign-out"></i> Logout</a></li>---------------------로그아웃 -->  
                ...
                <div class="panel-body">
                  <ul class="nav nav-pills flex-column text-sm">
                    ...
                    <li class="nav-item"><a href="customer-account.jsp" class="nav-link active"><i class="fa fa-list"></i>회원탈퇴</a></li>
